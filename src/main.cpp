      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (!pf.initialized()) {
            ...
            std::cout << "particle filter initialized: " << pf.initialized() << std::endl;            
          } else {
          ...
          std::cout << "x_sense size: " << x_sense.size() << std::endl;

          // Update the weights and resample
          pf.updateWeights(sensor_range, sigma_landmark, noisy_observations, map);
          // std::cout << "particle filter weights updated " << std::endl;
          pf.resample();
          // std::cout << "particle filter resampled " << std::endl;
          ...
          for (int i = 0; i < num_particles; ++i) {
            // std::cout << "number of particles: " << num_particles << " i " << i << " particle weight " << particles[i].weight << std::endl; 
